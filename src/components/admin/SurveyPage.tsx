...
const SurveyPage: React.FC = () => {
  ...
  // Changed: Always start in edit mode
  ...
  useEffect(() => {
    ...
    // Always stay in edit mode, regardless of whether questions exist
  ...
  const switchToCreateMode = () => {
    if (
      window.confirm(
        "Switch to create mode? This will clear current questions."
      )
    ) {
      setMode("create");
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md text-center animate-in slide-in-from-bottom-4 duration-300">
            ...
            <p className="mb-6 text-gray-700">
              ...
              <span className="font-semibold">{levelToDelete}</span> level
